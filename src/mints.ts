...
// pages, CoinMarketCap/CoinGecko listing pages) on 2026-06-08. All mints
// carry Backed Finance's vanity "Xs" address prefix. Verify on-chain before
// trusting them in production — token registries can drift and rogue lookalikes
// exist.
//
